          ...
          <div class="col-12">
            ...
            <div class="row">
              ...
              <div class="col-8">              
                ...
                {{$items->service->customer->name}}<br/>
                {{$items->service->customer->telp}}<br/>              
              </div>
            </div>
            <br/>
            <div class="row">
              <div class="col-4">
                <table class="table table-bordered">
                  <th><h4 class="code">{{$items->service->code}}</h4></th>
                </table>
              </div>
              <div class="col-8"></div>
            </div>
      ...
      <div class="row">
        <div class="col-6">
          <p class="highlight small">
            Terima Kasih<br/>
            Lampiran ini digunakan sebagai Lampiran Sementara Service Item yang telah selesai            
        </p>
          </p>
        </div>                           
        </div>
